...
<div class="wrapper">
	<div class="top">
    	<div class="logo">
        	<img src="resources/image/logo.png" alt="profzone" width="216" height="49" />
        </div>
        <div class="nav">
        	<a href="/">首页</a> | 
            <a href="http://www.johnnyeven.com/">博客</a> | 
            <a href="http://www.profzone.net/products.html">实验对象</a> | 
            <a href="http://www.profzone.net/about.html">关于</a>
        </div>
        <div class="clear"></div>
	</div>
    <div class="content">
    	<div class="left-arrow" id="prev">
        	<img src="resources/image/arrow_left.png" />
        </div>
    	<div class="right-arrow" id="next">
        	<img src="resources/image/arrow_right.png" />
        </div>
            ...
            <div class="slider">
                <div class="slider-item">
                    ...
                    <div class="slider-right">
                        ...
                        <p><a id="getCode" href="#" onClick="var _gaq = _gaq || [];_gaq.push(['_trackEvent', 'DownloadGame', 'coupon']);">领取下载码，更有好礼相送哦</a></p>
                        <p><a href="#" onClick="var _gaq = _gaq || [];_gaq.push(['_trackEvent', 'DownloadGame', 'appstore']);">App Store 下载 &gt;&gt;</a></p>
                    </div>
                    <div class="clear"></div>
                </div>
                <div class="clear"></div>
